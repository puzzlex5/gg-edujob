...
const culture={source:'레슨인포',sourceSurface:'culture-arts',sourceIdentity:'culture:id:94673',url:'https://www.lessoninfo.co.kr/culture-jobs/detail.php?id=94673'};
if(sandbox.postingLink(culture)!=='') throw new Error('Lessoninfo culture cold-link must fail closed');
