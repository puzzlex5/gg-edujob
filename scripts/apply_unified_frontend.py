...
if 'direct-link-guard.js' not in s:
    ...
    s=s[:i]+'<script src="direct-link-guard.js?v=20260906c" defer></script>\n'+s[i:]
else:
    s,n=re.subn(r'direct-link-guard\.js\?v=[A-Za-z0-9._-]+','direct-link-guard.js?v=20260906c',s,count=1)
