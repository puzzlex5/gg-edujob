...
support office. This crawler traverses independently verified CMS list boards until the
...
conceptual official-source count beyond the registry's support-office count.
"""
...
# These are alternative recruitment surfaces already observed on the official support-office
# hosts. They are kept explicit because silently guessing CMS menus is less safe than failing
# closed when a verified board moves.
BOARDS = [
    {
        "office": "동부교육지원청",
